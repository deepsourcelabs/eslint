/* eslint-disable eslint-comments/disable-enable-pair -- marvin-js */
...
function calculateStatsPerFile(messages) {
    return messages.reduce((stat, message) => {
        ...
        // marvin-js >
        // Group errors per file for ease in debugging
...
function verifyText({
    ...
    // marvin-js >
    // Log below information to help in debugging
    const stats = { ...calculateStatsPerFile(messages) };

    console.log(`\nFile: ${filePath}`);

    // console.log(`Lines: ${text.split(/\r\n|\r|\n/u).length}`);
    // console.log(`Errors: ${JSON.stringify(stats)}\n`);
    ...
    // marvin-js >
    // Commented to prevent the source code from being appended to the result object
    // if (
